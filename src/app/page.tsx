...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-stone-950 text-stone-100">
        ...
        <div className="mx-auto grid min-h-[48vh] max-w-6xl content-center gap-8 px-6 py-20 md:grid-cols-[1.35fr_0.65fr] md:px-10">
          ...
          <aside className="self-end rounded-3xl border border-emerald-400/20 bg-emerald-950/40 p-6">
            ...
            <ol className="mt-4 space-y-4 text-sm leading-6">
              <li>01 · Selecione a data da diária.</li>
      ...
      <section className="bg-stone-100 px-4 py-12 text-stone-900 md:px-10">
        <div className="mx-auto max-w-6xl">
          <div className="mb-7 max-w-2xl">
            <p className="text-sm font-semibold tracking-[0.18em] text-emerald-700 uppercase">Planeje sua visita</p>
            <h2 className="mt-2 text-3xl font-semibold tracking-tight md:text-4xl">Veja os dias que combinam com você</h2>
          </div>
          <AvailabilityCalendar selectedDate={selectedDate} onSelectDate={(date) => { setSelectedDate(date); document.getElementById("agendamento")?.scrollIntoView({ behavior: "smooth" }); }} />
        </div>
      </section>
      <section id="agendamento" className="bg-stone-100 px-4 py-12 text-stone-900 md:px-10">
        <div className="mx-auto max-w-6xl">
          <div className="mb-7">
            ...
            <h2 className="mt-2 text-3xl font-semibold">Reserve sua próxima diária</h2>
          </div>
          <FirebaseBookingForm initialDate={selectedDate} />
        </div>
      </section>
    </main>
  );
